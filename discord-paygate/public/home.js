...
(() => {
  ...
  if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
    img.src = '/shot-dashboard.png?v=64'; // hold a still frame instead
    return;
  }
  ...
  const sources = [
    ['/hero-demo.mp4?v=64', 'video/mp4; codecs="avc1.640020"'],
    ['/hero-demo.webm?v=64', 'video/webm; codecs="vp9"'],
  ];
...
const RIPLEY_TIERS = [
  ...
  { max: 50, cost: 9.99, label: 'Starter · $9.99/mo · 0% of sales' },
  { max: 500, cost: 29.99, label: 'Growth · $29.99/mo · 0% of sales' },
  { max: Infinity, cost: 99.99, label: 'Scale · $99.99/mo · 0% of sales' },
];
