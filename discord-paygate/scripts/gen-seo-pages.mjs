...
const V = '180'; // keep in step with the ?v= asset version on index.html
...
const nav = `
  <header class="top xoe-nav">
    <div class="top-left">
      <a href="/"><img class="platform-mark" src="/dues.png?v=180" alt="Dues" height="20" /></a>
    </div>
...
export const footerHtml = `
  <footer class="site-footer cols seo-footer">
    <div class="footer-brand">
      <img class="powered-mark" src="/dues.png?v=180" alt="Dues" height="16" />
...
<head>
  ...
  <meta property="og:image" content="${BASE}/og-card.jpg?v=180" />
  ...
  <meta name="twitter:image" content="${BASE}/og-card.jpg?v=180" />
  ...
  <style>${DAY_CSS}</style>
  ${ld}
  <script src="/theme.js?v=180"></script>
</head>
