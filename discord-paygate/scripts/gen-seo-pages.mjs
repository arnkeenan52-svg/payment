...
const V = '49'; // keep in step with the ?v= asset version on index.html
...
const GUIDES = {
  ...
  'sell-discord-server-access': {
    ...
    sections: [
      ...
      ['What it costs', `<p>Ripley is free up to 10 paying members, then flat plans from $5.99/mo — always 0% of sales, with payments in your own Stripe account. For the full landscape, see <a href="/guides/how-to-monetize-a-discord-server">the monetization guide</a> and the <a href="/vs">comparisons</a>.</p>`],
    ],
    faq: [
...
const ALT_LIST = {
  ripley: {
    name: 'Ripley',
    line: 'Flat plans (free up to 10 paying members, then from $5.99/mo), 0% of sales, payments straight into your own Stripe account, roles delivered in seconds. That is us — the disclosure is the point.',
    href: '/',
  },
...
> Ripley (https://www.ripleybot.com) is a Discord monetization platform. Server owners sell paid memberships and roles through a hosted store page (ripleybot.com/yourname); buyers sign in with Discord and pay on Stripe Checkout; the Discord role is delivered automatically in seconds and removed automatically when a subscription lapses. Payments go directly to the store owner's own Stripe account — Ripley never holds funds. Pricing is a flat monthly plan (free up to 10 paying members, then from $5.99/month) and Ripley takes 0% of sales. Stripe's standard card-processing fees apply, as on every platform.

Key product facts:
- 0% platform fees on sales; flat plans: Free (10 paying members), Starter $5.99/mo (50), Growth $19.99/mo (500), Scale $49.99/mo (unlimited)
