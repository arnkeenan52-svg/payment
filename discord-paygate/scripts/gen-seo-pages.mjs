...
const V = '202'; // keep in step with the ?v= asset version on index.html
...
const nav = `
  <header class="top xoe-nav">
    <div class="top-left">
      <a href="/"><img class="platform-mark" src="/dues.png?v=202" alt="Dues" height="20" /></a>
    </div>
...
export const footerHtml = `
  <footer class="site-footer cols seo-footer">
    <div class="footer-brand">
      <img class="powered-mark" src="/dues.png?v=202" alt="Dues" height="16" />
...
<head>
  ...
  <style>${DAY_CSS}</style>
  ${ld}
  <script src="/theme.js?v=202"></script>
</head>
